...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/08/07 16:09:29 by gscala            #+#    #+#             */
/*   Updated: 2021/08/07 16:09:31 by gscala           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_init2(t_philo *philo, t_mutex *mutex, int n, u_int64_t i)
{
	while (i < (u_int64_t)n)
	{
